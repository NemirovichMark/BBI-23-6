...
static class Hello
{
    ...
    //    }
    //}
    //static Sportsmen[] Sort(Sportsmen[] sport)
    //{
    ...
    //    sp[0] = new Sportsmen("Иванов", "Дмитрий", 3.15, 3.7);
    //    sp[1] = new Sportsmen("Дорогой", "Александр", 4.12, 4.20);
    //    sp[2] = new Sportsmen("Бруталов", "Фофан", 2.98, 3.34);
    //    sp[3] = new Sportsmen("Палец", "Безымянный", 3.19, 3.11);
    //    sp[4] = new Sportsmen("Просто", "Спортсмен", 5.11, 6.00);
