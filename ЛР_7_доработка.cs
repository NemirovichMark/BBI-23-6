...
static class Hello
{
    ...
    //    public bool getDisqualification { get { return disqualification; } }
    ...
    //    public void Print()
    //    {
    //        Console.WriteLine($"{Getfamile} {Getname} {rez}" + " " + "ID:" + ID);
    //    }
    ...
    public class Program
    {
        ...
        static Sportsmen[] Sort(Sportsmen[] list)
        {
        ...
        public static void Main(string[] args)
        {
            ...
            Sportsmen[] allgroup = new Sportsmen[n2 + n1];
